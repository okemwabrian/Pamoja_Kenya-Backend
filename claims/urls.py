...
urlpatterns = [
    path('', views.create_claim, name='create_claim'),  # POST /api/claims/ - Main endpoint
    path('list/', views.user_claims, name='user_claims'),  # GET /api/claims/list/
    path('submit/', views.submit_claim, name='submit_claim'),  # POST /api/claims/submit/ - Multipart
